    ...
    >
      <View style={styles.container}>
        ...
        <View style={styles.content}>
          ...
          Aqui você terá acesso á sua rede de apoio. São pessoas de sua confiança, para ajudar você em momentos difíceis.
          </Text>

          <TouchableOpacity style={styles.startButton} onPress={()=> navigation.navigate("RedeDeApoioPessoas")}>
            <Text style={styles.startButtonText}>Minha rede de apoio</Text>
          </TouchableOpacity>
        </View>
      </View>
    </ImageBackground>
